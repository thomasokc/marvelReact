...
import { DataTable, HeroForm, SignIn } from '../../components';
      ...
      <Box sx={{display:'flex'}} >
        ...
        >
          <Toolbar sx={myStyles.toolbar}>
            ...
            <Typography variant="h6" noWrap> Hello Heroes </Typography>
            <Button sx={myStyles.toolbar_button} onClick={handleDialogClickOpen}>Add a new hero</Button>
        ...
        <Box sx={ myStyles.content } >
          ...
          <h1>Data table was Thanos snapped</h1>
          <DataTable />
